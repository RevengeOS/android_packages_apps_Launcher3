...
public class SmartspaceQsbWidget extends QsbContainerView {
    private static final String WIDGET_CLASS_NAME = "com.revengeos.simpleweather.WeatherWidget";
    public static final String WIDGET_PACKAGE_NAME = "com.revengeos.simpleweather";
